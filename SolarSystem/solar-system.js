...
var urls = ["SolarSystem/textures/backgroundcube.png", "SolarSystem/textures/backgroundcube.png",
"SolarSystem/textures/backgroundcube.png", "SolarSystem/textures/backgroundcube.png",
"SolarSystem/textures/backgroundcube.png", "SolarSystem/textures/backgroundcube.png",];
...
// Load and configure textures
	...
	// Sun
	var texSol = new THREE.ImageUtils.loadTexture("SolarSystem/textures/sunmap.jpg");
	...
	// Mercury
	var texMerc = new THREE.ImageUtils.loadTexture("SolarSystem/textures/mercurymap.jpg");
	...
	// Venus
	var texVen = new THREE.ImageUtils.loadTexture("SolarSystem/textures/venusmap.jpg");
	...
	// Earth
	var texTie = new THREE.ImageUtils.loadTexture("SolarSystem/textures/earthmap1k.jpg");
	...
	//Moon
	var texLun = new THREE.ImageUtils.loadTexture("SolarSystem/textures/moonmap1k.jpg");
	...
	// Mars
	var texMart = new THREE.ImageUtils.loadTexture("SolarSystem/textures/marsmap1k.jpg");
	...
	// Jupiter
	var texJup= new THREE.ImageUtils.loadTexture("SolarSystem/textures/jupitermap.jpg");
	...
	// Saturn
	var texSat = new THREE.ImageUtils.loadTexture("SolarSystem/textures/saturnmap.jpg");
	...
	// Saturn rings
	var texSatRings = new THREE.ImageUtils.loadTexture("SolarSystem/textures/saturnringcolor.jpg");
	texSatRings.repeat.set(1,1);
	texSatRings.magFilter = THREE.LinearFilter; 
	texSatRings.minFilter = THREE.LinearFilter; 
	
	var texSatRingsAlpha = THREE.ImageUtils.loadTexture( "SolarSystem/textures/saturnringpatternrot.gif" );
	...
	// Uranus
	var texUra = new THREE.ImageUtils.loadTexture("SolarSystem/textures/uranusmap.jpg");
	...
	// Uranus rings 
	var texUraRings = new THREE.ImageUtils.loadTexture("SolarSystem/textures/uranusringcolour.jpg");
	texUraRings.repeat.set(1,1);
	texUraRings.magFilter = THREE.LinearFilter; 
	texUraRings.minFilter = THREE.LinearFilter; 


	var texUraRingsAlpha = THREE.ImageUtils.loadTexture( "SolarSystem/textures/uranusringtrans.gif" );
	...
	// Neptune
	var texNep = new THREE.ImageUtils.loadTexture("SolarSystem/textures/neptunemap.jpg");
	...
	{ 
		map: new THREE.ImageUtils.loadTexture( 'SolarSystem/textures/lensflare.png' ), 
